document.addEventListener("DOMContentLoaded", function () {
    ...
    <style>
        ...
        .asw-menu { display: none; top: 20px; border-radius: 8px; box-shadow: -1px 0 20px -14px ; opacity: 1; background: ${options.menuBackgroundColor}; width: 500px; line-height: 1; font-size: 14px; height: calc(100vh - 40px - 75px); letter-spacing: .015em; color: ${options.menuTextColor}; }
    ...
    const c = function (t, e) {
        ...
        if (t) {
            let a = "";
            "dark-contrast" == t ? a = "color: #fff !important;fill: #FFF !important;background-color:  !important;" : "light-contrast" == t ? a = " color:  !important;fill:  !important;background-color: #FFF !important;" : "high-contrast" == t ? a += d("contrast(125%)") : "high-saturation" == t ? a += d("saturate(200%)") : "low-saturation" == t ? a += d("saturate(50%)") : "monochrome" == t && (a += d("grayscale(100%)"));
            let n = [""];
